...
class LoadGraphAndFilterByRandomRadiusd(MapTransform):
    ...
    def __call__(self, data):
        if rasterize_forest is None:
            raise ModuleNotFoundError(
                "vessel_graph_generation is required for LoadGraphAndFilterByRandomRadiusd. "
                "Install/clone that package when using graph-CSV rasterization transforms."
            )
