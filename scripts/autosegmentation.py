...
# Make local OCTA-autoseg package tree importable when running from project root.
PROJECT_ROOT = Path(__file__).resolve().parents[1]
OCTA_AUTOSEG_DIR = PROJECT_ROOT / "OCTA-autoseg"
if OCTA_AUTOSEG_DIR.is_dir():
    sys.path.insert(0, str(OCTA_AUTOSEG_DIR))
